  ...
  return (
    <Layout title="Community" hasTabBar>
      <div className="py-16 space-y-8 px-4">
        {[1, 2, 3, 4, 5, 6].map((el) => (
          <div className="flex flex-col items-start" key={el}>
        ...
        <button className="fixed bottom-24 right-5 shadow-xl hover:bg-orange-500 cursor-pointer bg-orange-400 rounded-full p-3 text-white colors-transition">
          <svg
            className="w-6 h-6"
            fill="none"
            stroke="currentColor"
